...
class CameraThread(QtCore.QThread):
    pngSaved = QtCore.pyqtSignal(str)
...
class StartScan(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.camera.pngSaved.connect(self.updatePreview)
        self.camera.start()
        self.last_text = ""
        self.image_file = "./img"
    ...
    def snapshot(self):
        ...
        self.camera.save(self.image_file + self.saved_image_format)
    ...
    def refreshCameras(self):
        ...
        if self.camera.isRunning() == False:
            self.camera.start()
    ...
    def getinput(self):
        ...
        if self.ui.txtInput.text() != "":
            ...
            self.ui.txtHistory.setPlainText(str(self.record_count) + ": " + self.last_text + "\n" + self.ui.txtHistory.toPlainText())
